...
namespace GameManager
{
  internal class SceneEnd : Scene
  {
    ...
    public override void Load()
    {
      ...
      {
        this.TextNbDeath[index] = new Text(AssetManager.FontPixelmaster28, "Level " + (object) (index + 1) + " - " + (object) Game1.NB_DEATH[index] + " Deaths", new Vector2(0.0f, Camera.Position.Y + (float) Camera.VisibleArea.Height * 0.3f + (float) (40 * index)), Color.Black);
