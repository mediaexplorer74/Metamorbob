...
namespace GameManager
{
  internal class AssetManager
  {
    ...
    private static T Load<T>(string contentName) => Game1.Instance.Content.Load<T>(contentName);
    ...
    public static void Load()
    {
      ...
      AssetManager.Sound_Bosslanding = new Sound(AssetManager.Load<SoundEffect>("Sounds/BossLanding"), Game1.VOLUME_SFX);
      AssetManager.Sound_Boxexplode = new Sound(AssetManager.Load<SoundEffect>("Sounds/BoxExplode"), Game1.VOLUME_SFX);
      AssetManager.Sound_Enemydamage = new Sound(AssetManager.Load<SoundEffect>("Sounds/EnemyDamage"), Game1.VOLUME_SFX);
      AssetManager.Sound_Enemydie = new Sound(AssetManager.Load<SoundEffect>("Sounds/EnemyDie"), Game1.VOLUME_SFX);
      AssetManager.Sound_Footstep = new Sound(AssetManager.Load<SoundEffect>("Sounds/Footstep"), Game1.VOLUME_SFX);
      AssetManager.Sound_Impact = new Sound(AssetManager.Load<SoundEffect>("Sounds/Impact"), Game1.VOLUME_SFX);
      AssetManager.Sound_Jump = new Sound(AssetManager.Load<SoundEffect>("Sounds/Jump"), Game1.VOLUME_SFX);
      AssetManager.Sound_Landing = new Sound(AssetManager.Load<SoundEffect>("Sounds/Landing"), Game1.VOLUME_SFX);
      AssetManager.Sound_Shoot = new Sound(AssetManager.Load<SoundEffect>("Sounds/Shoot"), Game1.VOLUME_SFX);
      AssetManager.Sound_Switch = new Sound(AssetManager.Load<SoundEffect>("Sounds/Switch"), Game1.VOLUME_SFX);
    }
  }
}
