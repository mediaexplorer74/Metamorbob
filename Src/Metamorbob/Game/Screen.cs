...
namespace GameManager
{
  public class Screen
  {
    ...
    public void Render()
    {
      ...
      this.mainGame.spriteBatch.Begin((SpriteSortMode) 2, BlendState.Opaque, this.SamplerState, DepthStencilState.None, RasterizerState.CullNone, this.Effect, new Matrix?());
      if (this.Effect != null)
        this.Effect.CurrentTechnique.Passes[0].Apply();
      Vector2 vector2 = Vector2.Add(this.Offset, this.OffsetAdd);
      if (Vector2.Equals(vector2, Vector2.Zero))
      {
        this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, this.DrawRect, new Rectangle?(this.screenRect), Color.White);
      }
      else
      {
        ...
        if ((double) vector2.X == 0.0)
        {
          ...
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X, this.DrawRect.Y + num, this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X, this.DrawRect.Y + (num >= 0 ? num - (int) ((double) this.Height * (double) this.Scale) : num + (int) ((double) this.Height * (double) this.Scale)), this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
        }
        else if ((double) vector2.Y == 0.0)
        {
          int num = (int) Math.Round((double) vector2.X * (double) this.Scale, MidpointRounding.AwayFromZero);
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X + num, this.DrawRect.Y, this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X + (num >= 0 ? num - (int) ((double) this.Width * (double) this.Scale) : num + (int) ((double) this.Width * (double) this.Scale)), this.DrawRect.Y, this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
        }
        else
        {
          ...
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X + num1, this.DrawRect.Y + num2, this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X + num1, this.DrawRect.Y + num4, this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X + num3, this.DrawRect.Y + num2, this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
          this.mainGame.spriteBatch.Draw((Texture2D) this.RenderTarget, new Rectangle(this.DrawRect.X + num3, this.DrawRect.Y + num4, this.DrawRect.Width, this.DrawRect.Height), new Rectangle?(this.screenRect), Color.White);
        }
      }
    ...
    private void SetWindowSize(int width, int height)
    {
      ...
      this.Matrix = Matrix.Multiply(Matrix.CreateScale(this.scale), Matrix.CreateTranslation((float) this.DrawRect.X, 0.0f, 0.0f));
    }
    ...
    public void DisableFullscreen() => this.DisableFullscreen(this.OrigScale);

    public int ScaledWidth => (int) ((double) this.width * (double) this.scale);

    public int ScaledHeight => (int) ((double) this.height * (double) this.scale);

    public bool IsFullscreen => this.Graphics.IsFullScreen;

    public Vector2 Size => new Vector2((float) this.Width, (float) this.Height);

    public int Width => ((Texture2D) this.RenderTarget).Width;

    public int Height => ((Texture2D) this.RenderTarget).Height;

    public Vector2 Center => Vector2.Multiply(this.Size, 0.5f);
