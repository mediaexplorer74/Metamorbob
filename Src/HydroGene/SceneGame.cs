...
namespace HydroGene
{
  internal class SceneGame : Scene
  {
    ...
    public override void Load()
    {
      ...
      if (MainGame.CURRENT_LEVEL == (byte) 5)
      {
        MediaPlayer.Stop();
      ...
      this.Level = new TileMap("Content/Levels/Level" + (object) MainGame.CURRENT_LEVEL + ".tmx", AssetManager.Tileset);
    ...
    public override void Update(GameTime gameTime)
    {
      ...
      if (MainGame.CURRENT_LEVEL == (byte) 5 && (double) this.boss.Alpha == 0.0)
